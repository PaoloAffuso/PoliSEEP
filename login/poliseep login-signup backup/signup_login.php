...
<!--   <nav class="navbar navbar-dark fixed-top bg-dark">
        <div class="container-fluid navcontainer">
            <a class="navbar-brand brand-name" href="signup_login.php"><b>PoliSEEP</b> : A smart Software Engineering Education Platform
            </a>
        </div>
    </nav> -->
                <!--FORMS-->
                                    ...
                                    <form class="frm" id="frm" action="./php/login_ls.php" method="POST" class="text-white">
                                        <div class="input-field">
                                            <input type="text" placeholder="Enter your e-mail" required name="email"
                                                id="email" value="<?php if(isset($_COOKIE["email"])) { echo $_COOKIE["email"]; } ?>" required />
                                            <i class="uil uil-envelope icon"></i>
                                        </div>

                                        <div class="input-field">
                                            <input type="password" class="password" placeholder="Enter your password"
                                                required name="password" id="password" value="<?php if(isset($_COOKIE["password"])) { echo $_COOKIE["password"]; } ?>" required/>
